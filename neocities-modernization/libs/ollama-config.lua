...
local function detect_ollama_endpoint()
    ...
    -- Updated to prioritize port 10265 for router accessibility
    local endpoints = {
        "http://192.168.0.115:10265",  -- Primary: Router accessible port
        "http://localhost:10265",
        "http://127.0.0.1:10265",
        "http://192.168.0.115:11434",  -- Fallback: Non-CUDA version
...
local function get_ollama_endpoint()
    ...
    -- Default fallback - standardized to port 10265
    return "http://localhost:10265"
end
-- }}}
