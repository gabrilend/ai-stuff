...
- [x] Full regeneration and visual verification
- [x] Test with browser to confirm rendering is fixed
- [x] Verified: 228 properly escaped entities in chronological/01.html
- [x] Verified: `<pre>` tags balanced (34 opening, 34 closing)
- [x] Both main thread and effil worker thread apply escaping
