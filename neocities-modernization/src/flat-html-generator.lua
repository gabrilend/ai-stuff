...
function M.generate_explore_math_page(output_dir, poems_data)
    ...
    add("  likely. The shuffle is re-seeded from the clock on each build, so the")
    add("  words land in a different arrangement every time the site is rebuilt --")
    add("  the sizes and the colors, though, stay fixed.")
    add("")
