...
- Air-gapped P2P networking for secure real-time collaboration
- Local AI infrastructure for LLM assistance via P2P WiFi Direct to laptop daemons
...
- TCP server on port 8080 for laptop daemon (localhost only, proxy for air-gapped devices)
