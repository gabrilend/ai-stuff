...
| `411` | A radical makes its own strokes | **completed** — the shape from the stroke, the substance from its radical |
| `412` | A style is a thing you can ask for | **completed** — and four refusals no style may lift |
