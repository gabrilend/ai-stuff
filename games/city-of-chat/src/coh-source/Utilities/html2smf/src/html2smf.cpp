...
int AsciiToUTF8(int character)
{
    ...
    switch (character)
    {
        ...
        case 0x00:
            return 0x0000; // NULL
        case 0x01:
            return 0x0001; // START OF HEADING
        case 0x02:
            return 0x0002; // START OF TEXT
        case 0x03:
            return 0x0003; // END OF TEXT
        case 0x04:
            return 0x0004; // END OF TRANSMISSION
        case 0x05:
            return 0x0005; // ENQUIRY
        case 0x06:
            return 0x0006; // ACKNOWLEDGE
        case 0x07:
            return 0x0007; // BELL
        case 0x08:
            return 0x0008; // BACKSPACE
        case 0x09:
            return 0x0009; // HORIZONTAL TABULATION
        case 0x0A:
            return 0x000A; // LINE FEED
        case 0x0B:
            return 0x000B; // VERTICAL TABULATION
        case 0x0C:
            return 0x000C; // FORM FEED
        case 0x0D:
            return 0x000D; // CARRIAGE RETURN
        case 0x0E:
            return 0x000E; // SHIFT OUT
        case 0x0F:
            return 0x000F; // SHIFT IN
        case 0x10:
            return 0x0010; // DATA LINK ESCAPE
        case 0x11:
            return 0x0011; // DEVICE CONTROL ONE
        case 0x12:
            return 0x0012; // DEVICE CONTROL TWO
        case 0x13:
            return 0x0013; // DEVICE CONTROL THREE
        case 0x14:
            return 0x0014; // DEVICE CONTROL FOUR
        case 0x15:
            return 0x0015; // NEGATIVE ACKNOWLEDGE
        case 0x16:
            return 0x0016; // SYNCHRONOUS IDLE
        case 0x17:
            return 0x0017; // END OF TRANSMISSION BLOCK
        case 0x18:
            return 0x0018; // CANCEL
        case 0x19:
            return 0x0019; // END OF MEDIUM
        case 0x1A:
            return 0x001A; // SUBSTITUTE
        case 0x1B:
            return 0x001B; // ESCAPE
        case 0x1C:
            return 0x001C; // FILE SEPARATOR
        case 0x1D:
            return 0x001D; // GROUP SEPARATOR
        case 0x1E:
            return 0x001E; // RECORD SEPARATOR
        case 0x1F:
            return 0x001F; // UNIT SEPARATOR
        case 0x20:
            return 0x0020; // SPACE
        case 0x21:
        ...
        case 0x2E:
            return 0x002E; // FULL STOP
        case 0x2F:
            return 0x002F; // SOLIDUS
        case 0x30:
            return 0x0030; // DIGIT ZERO
        case 0x31:
            return 0x0031; // DIGIT ONE
        case 0x32:
            return 0x0032; // DIGIT TWO
        case 0x33:
            return 0x0033; // DIGIT THREE
        case 0x34:
            return 0x0034; // DIGIT FOUR
        case 0x35:
            return 0x0035; // DIGIT FIVE
        case 0x36:
            return 0x0036; // DIGIT SIX
        case 0x37:
            return 0x0037; // DIGIT SEVEN
        case 0x38:
            return 0x0038; // DIGIT EIGHT
        case 0x39:
            return 0x0039; // DIGIT NINE
        case 0x3A:
            return 0x003A; // COLON
        case 0x3B:
        ...
        case 0x40:
            return 0x0040; // COMMERCIAL AT
        case 0x41:
            return 0x0041; // LATIN CAPITAL LETTER A
        case 0x42:
            return 0x0042; // LATIN CAPITAL LETTER B
        case 0x43:
            return 0x0043; // LATIN CAPITAL LETTER C
        case 0x44:
            return 0x0044; // LATIN CAPITAL LETTER D
        case 0x45:
            return 0x0045; // LATIN CAPITAL LETTER E
        case 0x46:
            return 0x0046; // LATIN CAPITAL LETTER F
        case 0x47:
            return 0x0047; // LATIN CAPITAL LETTER G
        case 0x48:
            return 0x0048; // LATIN CAPITAL LETTER H
        case 0x49:
            return 0x0049; // LATIN CAPITAL LETTER I
        case 0x4A:
            return 0x004A; // LATIN CAPITAL LETTER J
        case 0x4B:
            return 0x004B; // LATIN CAPITAL LETTER K
        case 0x4C:
            return 0x004C; // LATIN CAPITAL LETTER L
        case 0x4D:
            return 0x004D; // LATIN CAPITAL LETTER M
        case 0x4E:
            return 0x004E; // LATIN CAPITAL LETTER N
        case 0x4F:
            return 0x004F; // LATIN CAPITAL LETTER O
        case 0x50:
            return 0x0050; // LATIN CAPITAL LETTER P
        case 0x51:
            return 0x0051; // LATIN CAPITAL LETTER Q
        case 0x52:
            return 0x0052; // LATIN CAPITAL LETTER R
        case 0x53:
            return 0x0053; // LATIN CAPITAL LETTER S
        case 0x54:
            return 0x0054; // LATIN CAPITAL LETTER T
        case 0x55:
            return 0x0055; // LATIN CAPITAL LETTER U
        case 0x56:
            return 0x0056; // LATIN CAPITAL LETTER V
        case 0x57:
            return 0x0057; // LATIN CAPITAL LETTER W
        case 0x58:
            return 0x0058; // LATIN CAPITAL LETTER X
        case 0x59:
            return 0x0059; // LATIN CAPITAL LETTER Y
        case 0x5A:
            return 0x005A; // LATIN CAPITAL LETTER Z
        case 0x5B:
        ...
        case 0x5F:
            return 0x005F; // LOW LINE
        case 0x60:
            return 0x0060; // GRAVE ACCENT
        case 0x61:
            return 0x0061; // LATIN SMALL LETTER A
        case 0x62:
            return 0x0062; // LATIN SMALL LETTER B
        case 0x63:
            return 0x0063; // LATIN SMALL LETTER C
        case 0x64:
            return 0x0064; // LATIN SMALL LETTER D
        case 0x65:
            return 0x0065; // LATIN SMALL LETTER E
        case 0x66:
            return 0x0066; // LATIN SMALL LETTER F
        case 0x67:
            return 0x0067; // LATIN SMALL LETTER G
        case 0x68:
            return 0x0068; // LATIN SMALL LETTER H
        case 0x69:
            return 0x0069; // LATIN SMALL LETTER I
        case 0x6A:
            return 0x006A; // LATIN SMALL LETTER J
        case 0x6B:
            return 0x006B; // LATIN SMALL LETTER K
        case 0x6C:
            return 0x006C; // LATIN SMALL LETTER L
        case 0x6D:
            return 0x006D; // LATIN SMALL LETTER M
        case 0x6E:
            return 0x006E; // LATIN SMALL LETTER N
        case 0x6F:
            return 0x006F; // LATIN SMALL LETTER O
        case 0x70:
            return 0x0070; // LATIN SMALL LETTER P
        case 0x71:
            return 0x0071; // LATIN SMALL LETTER Q
        case 0x72:
            return 0x0072; // LATIN SMALL LETTER R
        case 0x73:
            return 0x0073; // LATIN SMALL LETTER S
        case 0x74:
            return 0x0074; // LATIN SMALL LETTER T
        case 0x75:
            return 0x0075; // LATIN SMALL LETTER U
        case 0x76:
            return 0x0076; // LATIN SMALL LETTER V
        case 0x77:
            return 0x0077; // LATIN SMALL LETTER W
        case 0x78:
            return 0x0078; // LATIN SMALL LETTER X
        case 0x79:
            return 0x0079; // LATIN SMALL LETTER Y
        case 0x7A:
            return 0x007A; // LATIN SMALL LETTER Z
        case 0x7B:
        ...
        case 0xD0:
            return 0x00D0; // LATIN CAPITAL LETTER ETH
        case 0xD1:
...
PARSING_MODE ParseSpecial(const char* tagBuffer, int tagSize, FILE* outFile)
{
    ...
    if (strcmp(tagBuffer, "&nbsp;") == 0 || strcmp(tagBuffer, "&lt;") == 0 || strcmp(tagBuffer, "&gt;") == 0 || strcmp(tagBuffer, "&amp;") == 0 ||
        strcmp(tagBuffer, "&#37;") == 0)
    {
        OutputString(tagBuffer, outFile);
        return PARSING_COPY;
