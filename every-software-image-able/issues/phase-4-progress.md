...
| | | Status |
|---|---|---|
| `401` | The second and third tongues | **in progress** — all ten routines written for the second architecture and proved bit-identical on a real ARM machine, 250 of 250; a whole pass there is untested, and the third architecture is not begun |
