...
| `107` | The driver, and what a machine cannot be told | **in progress** — the whole setup is written and proved: find the weights, divide the memory, fill the plan, and on the first architecture think the recorded answer, 10 of 10; the loop and the hands are not |
