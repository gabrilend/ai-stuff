# 122-test-sampler-riscv64 — info

Choosing what to say next, in the third tongue, on a real emulated RISC-V machine -- held to the first architecture choice for choice. Issue 401.
...
change the comments in `122-test-sampler-riscv64.lua` and run the sweep again.*
