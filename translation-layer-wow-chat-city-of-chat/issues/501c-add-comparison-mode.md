# Issue 501c: Add Comparison Mode
...
## Intended Behavior
 ...
 Implement side-by-side view showing WoW packet alongside CoH equivalent with field alignment 
...
- 501-build-protocol-packet-visualizer.md (parent issue)
