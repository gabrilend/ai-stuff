...
| `soldier.slot_bearing` | double[] | Where it stands in its formation, as an angle from the direction of travel: 0 dead ahead, a quarter turn at the flank, half a turn at the rear. |
| `soldier.slot_distance` | double[] | How far out from the formation's centre it stands. |
