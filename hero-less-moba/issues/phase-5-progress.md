...
| Issue | | Status |
| --- | --- | --- |
| 501 | The commander catalogue | not started |
| 502 | Killing pays everyone on the team | not started |
| 503 | A hero is a soldier you bought | not started |
| 504 | Abilities are a dispatch table | not started |
| 505 | Spawning onto a wave | not started |
| 506 | Spawning onto a tower, and being pushed back | not started |
