...
> The parser does have a special case. Let me read it, and check the
> user-message branch for a gap I think I see.

> Found two concrete defects. Let me confirm them against the actual generated
> transcript.

> Confirmed — and worse than I expected. Let me now scan for the other
> artifact classes across the corpus.
...
```
<local-command-stdout>Set model to Opus 5 (1M context) and saved as
...
> Issue 019's line 43 documents the *old* result format — that stale doc is
> what caused the bug. Let me check the project's doc layout before writing.
