...
| 309 | the two doors | where a program's arguments arrive and its results come from — and composition falling out of it |
...
| can a program have more than one door out? | 309 | several shapes of the same result, chosen by rewiring, is genuinely useful |
