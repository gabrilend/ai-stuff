...
|-----------|-------------|--------|
| [305a-parser-infrastructure.md](305a-parser-infrastructure.md) | Parser state, helpers, error handling, AST node types | Created |
| [305b-parse-declarations.md](305b-parse-declarations.md) | Type, globals, native, function signature parsing | Created |
| [305c-parse-expressions.md](305c-parse-expressions.md) | Expression parsing with operator precedence | Created |
| [305d-parse-statements.md](305d-parse-statements.md) | All JASS statement types and function bodies | Created |
| [305e-parser-tests.md](305e-parser-tests.md) | Comprehensive test suite for parser validation | Created |
