...
|-------|-------------|--------|
| 202a-parse-unitsdoo-header-and-basic-fields.md | File header, basic unit fields (type, position, player, HP/MP) | Pending |
| 202b-parse-unitsdoo-item-drops.md | Item drop tables (items dropped on death) | Pending |
| 202c-parse-unitsdoo-abilities.md | Modified abilities (autocast, levels) | Pending |
| 202d-parse-unitsdoo-hero-data.md | Hero-specific data (level, stats, inventory) | Pending |
| 202e-parse-unitsdoo-random-and-waygate.md | Random unit config, waygate destinations | Pending |
