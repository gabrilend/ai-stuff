...
The following sub-issue files were generated from the analysis above:

| File | Description |
|------|-------------|
| `401a-core-fixed-timestep-loop.md` | Core game loop with fixed timestep, time tracking, pause/resume/speed |
| `401b-timer-subsystem.md` | WC3-compatible timer system with priority queue |
...
*Auto-generated on 2025-12-27 01:32*

- 401a-core-fixed-timestep-loop.md
- 401b-timer-subsystem.md
