...
- [ ] Recipe definitions follow consistent schema
- [ ] Recipes can be registered and queried
- [ ] Entities can learn/unlearn recipes
- [ ] Skill difficulty colors calculate correctly
- [ ] Recipe sources (trainer, drop, etc.) work
- [ ] Discovery system randomly teaches recipes
- [ ] Recipes loadable from data files
- [ ] WC3 upgrade/shop mapping works
- [ ] Events fire for learning and discovery
