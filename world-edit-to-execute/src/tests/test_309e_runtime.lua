#!/usr/bin/env luajit
-- {{{ test_309e_runtime.lua
-- Integration test runner for trigger runtime (Issue 309e)
-- Runs all trigger runtime test suites from 307 and aggregates results.
-- Run from project root: luajit src/tests/test_309e_runtime.lua
...
-- {{{ Main
print("===========================================================")
print("  Issue 309e: Trigger Runtime Integration Tests")
print("===========================================================\n")

local total_passed = 0
local total_failed = 0

-- Run all trigger runtime test suites
local suites = {
    {"Trigger Data Structures (307a)", "test_triggers_307a.lua"},
    {"Trigger Lifecycle (307b)", "test_triggers_307b.lua"},
    {"Condition/Action System (307c)", "test_triggers_307c.lua"},
    {"Trigger Context (307d)", "test_triggers_307d.lua"},
    {"Comprehensive (307)", "test_triggers.lua"},
}
