...
t_counter_wrap | s | derived | 2^w_counter / (f_face * 1e9)  | how long a counter runs at full rate before it wraps
C_ctrl        | bit | derived | n_reg_ctrl * 64               | the register file, at sixty-four bits a register
