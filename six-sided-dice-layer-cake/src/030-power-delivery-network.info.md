...
| `n_pillar_pwr` | 1 | derived | 2.116e+06 | radial pillars carrying current inward rather than data |
...
| `I_pillar_cap` | A | derived | 10580 A | current the radial pillar array will carry inward |
| `f_pillar_used` | 1 | derived | 0.0029689 | how much of that capability the core's inward supply actually uses |
