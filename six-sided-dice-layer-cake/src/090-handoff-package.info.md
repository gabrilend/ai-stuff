...
| `n_con_pkg` | 1 | derived | 573 | constraints |
...
| `f_derived` | 1 | derived | 0.589051 | share of the project's numbers that are worked out rather than chosen or measured |
...
| `n_constraint` | `087` | 573 | constraints in it -- from 103. Carried as a hand count until it was twelve short, which is the exact failure a self-describing document is prone to |
