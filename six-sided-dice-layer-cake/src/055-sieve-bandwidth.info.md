...
| `B_spout_avg` | bit/s | derived | unresolved | the spout, averaged over how often a pane is actually taken |
...
| `m_link` | 1 | derived | 1.89421e+07 | the link's, counting pads rather than power |
...
| `B_link_pads` | `051` | 5.819e+21 bit/s | what the pad count alone would permit |
