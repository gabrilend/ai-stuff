...
```symbols
dT_walk_max   | K | given | 1.0   | the most the walking hot spot may swing over one pipeline stage before the face ordering in 010 would have to be taken seriously
